...
The log includes request sizes, hashed session/cache IDs, timeout suppression events, response-header timing, patch re-install events, and errors. It does not log prompts or response bodies.
