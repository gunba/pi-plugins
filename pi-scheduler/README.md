...
Receipt checks also run before model requests, so an admitted steering message
leaves the queue and widget during active work, without waiting for the agent
